...
export const MultiplayerModal = component$(
  ({ onClose }: { onClose: QRL<() => void> }) => {
    return (
        ...
        >
            ...
            >
                <h2 class="text-xl font-bold mb-4 pixelated-text">Multiplayer</h2>
                <p class="mb-4 pixelated-text">Escolha o tipo de partida:</p>
                <div class="flex flex-col gap-2">
                    <button
                        onClick$={() => alert('Partida Rápida selecionada!')}
                        class="w-full px-4 py-2 bg-white text-black border-2 border-black pixelated-button hover:bg-gray-100"
                    >
                        Partida Rápida
                    </button>
                    <button
                        onClick$={() => alert('Torneio selecionado!')}
                        class="w-full px-4 py-2 bg-white text-black border-2 border-black pixelated-button hover:bg-gray-100"
                    >
                        Torneio
                    </button>
